...
class Customer
{
    ...
    public function hydrate(array|self $SourceInfo)
    {
        ...
        foreach ($SourceInfo as $key => $value) {
            ...
            if (($value == null && $value != false) || ! method_exists($this, $method)) {
                continue;
            }
    ...
    public function isValid(): bool
    {
        ...
        if (! isset($this->organisationNumber) || empty($this->organisationNumber)) {
            return false;
        }
        if (! isset($this->type) || empty($this->type)) {
            return false;
        }
        if (! isset($this->VATType) || empty($this->VATType)) {
            return false;
        }
        if (! isset($this->customerNumber) || empty($this->customerNumber)) {
            return false;
        }
